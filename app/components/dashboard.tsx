...
const initialMockCourses: Course[] = [
  {
    ...
    completed: false,
    icon: "💻",
    user_id: "local-user-1", // Default user ID for mock data
...
export function Dashboard() {
  ...
  const fetchCourses = async () => {
    setLoading(true);
    // For now, show initial mock courses until you implement Firebase course storage
    // You can later replace this with Firebase Firestore queries
    const userCourses = user
      ? initialMockCourses.filter((c: Course) => c.user_id === user.id)
      : initialMockCourses;
      ...
      <div>
        ...
        <div className="mt-2">
          <Badge variant="outline" className="border-green-200 bg-green-50 text-green-800">
            🔥 Firebase Mode - Real-time sync enabled
          </Badge>
        </div>
      </div>
      ...
      <Card className="border-green-200 bg-green-50">
        <CardContent className="pt-6">
          <div className="flex items-center gap-2 text-green-800">
            ...
            <p className="text-sm">
              <strong>Firebase Mode:</strong> All data is synchronized in real-time with Firebase. 
        ...
        <div className="flex gap-2 mb-6">
          ...
          {selectedCourse.completed && (
            <Button
              ...
              onClick={() => setCurrentModule("certificate")}
            >
              Certificate
            </Button>
          )}
